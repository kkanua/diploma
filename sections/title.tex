...
\noindent
{\fnt{11}Тема работы}
$\overset{\text{\fnt{11}Разработка программного обеспечения для онлайн}}{\underline{\hspace{0.855\textwidth}}}$

\noindent
$\overset{\text{\fnt{11}\hspace{0.16\textwidth}монитора светимости детектора Belle II}}{\underline{\hspace{\textwidth}}}$
...
\fnt{11}канд. физ.-мат. наук           & \fnt{11} \\
\fnt{11}с.н.с ИЯФ СО РАН               & \fnt{11}ст. лаб. ИЯФ СО РАН \\
